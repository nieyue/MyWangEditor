...
//				fileOriginalName=fileOriginalName.replace(".png", ".jpg");
//			}
			
            fileName = DateUtil.timeStamp()+ fileOriginalName; 
         //创建路径
           if(imgdir!=null){
           MyFile myfile=new MyFile();
           myfile.createDir(path+rooturl+"/"+imgdir);
...
//           .toFile(localFile.getAbsolutePath());  
           ...
           //ImageIO.write(thumbnail, "JPEG", new File(path+rooturl+"/"+imgdir,fileName));
           }
		return rooturl+"/"+imgdir+"/"+fileName;
	}
